...
export const Leaderboard = () => {
  const entries: LeaderboardEntry[] = [{
    position: 1,
    userId: "user911268c8-8a8",
    amount: "21.70659",
    usdAmount: "$24.93",
    avatarColor: "bg-yellow-400"
  }, {
    position: 2,
    userId: "user55c6606e-486",
    amount: "18.00718",
    usdAmount: "$20.68",
    avatarColor: "bg-gray-300"
  }, {
    position: 3,
    userId: "user457a6b51-aaa",
    amount: "15.25736",
    usdAmount: "$17.53",
    avatarColor: "bg-orange-400"
  }, {
    position: 4,
    userId: "user09c0414e-3c6",
    amount: "13.36083",
    usdAmount: "$15.35",
    avatarColor: "bg-purple-400"
  }, {
    position: 5,
    userId: "userd3f77cb8ee28",
    amount: "13.06169",
    usdAmount: "$15.00",
      ...
      <div className="container mx-auto px-4">
        ...
        loop: true
          ...
          <CarouselContent className="-ml-2 md:-ml-4">
            {entries.map(entry => <CarouselItem key={entry.position} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
