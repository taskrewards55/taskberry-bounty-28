...
export const EarningsOverview = () => {
  ...
  useEffect(() => {
    ...
    const channel = supabase.channel('balance-updates').on('postgres_changes', {
      event: '*',
      schema: 'public',
      table: 'profiles'
    }, (payload: any) => {
  ...
  return <div className="space-y-4">
      <h2 className="text-2xl font-bold mb-4 text-zinc-950">Earnings Overview</h2>
      ...
      {balance < withdrawalThreshold && <Alert variant="destructive" className="bg-red-900 border-red-600">
